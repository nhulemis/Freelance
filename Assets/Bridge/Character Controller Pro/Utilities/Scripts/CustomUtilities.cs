...
{
    public static Vector3 ProjectVectorOnPlane( Vector3 vector , Vector3 planeNormal , Vector3 up , bool maintainMagnitude = true )
    {        
		Vector3 rotationAxis = Vector3.Cross( vector , up ).normalized;
