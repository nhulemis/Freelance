...
namespace Game_nham.Scripts
{
    public class Bullet : MonoBehaviour
    {
        ...
        [SerializeField] private Rigidbody2D rb; // Rigidbody component of the bullet

        // Start is called once when the bullet is instantiated
        public void Start()
        {
            // Set the velocity of the bullet to make it move
 ...
 private void Update()
        ...
        // OnTriggerEnter2D is called when the bullet collides with another collider
        public void OnTriggerEnter2D(Collider2D collision)
        {
            // Implement any bullet collision logic here if needed
            // For example, if you want the bullet to destroy itself when colliding with an enemy:
