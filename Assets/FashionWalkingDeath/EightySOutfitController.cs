...
public class EightySOutfitController : MonoBehaviour
{
    //Serialized Data
    ...
    public void selectGlassesOutfits(int levelIndex, int hairIndex)
    {
        print("Changing Gala Shoe levele index : " + levelIndex + " & selected shoe is :" + hairIndex);
        disableBottomOutfit();
        galaLevels[0].selectGlassesItem(levelIndex);
    }
