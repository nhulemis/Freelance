...
namespace ayxd_b
{
    public class GameManager : MonoBehaviour
    {
        ...
        [Header("Game settings")] [Space(5)] public float minYObstaclePosition = -4f;
        [Space(5)] public float maxYObstaclePosition = 2f;
        [Space(5)] public Color[] obstacleColors;

        readonly float
            xDistanceBetweenObstacles =
                2.5f; //fixed because of first jump, if you change this then you need to change jump force too
        ...
        public void CreateNewObstacle()
        {
            ...
            float newObstacleY = Random.Range(lastObstacle.transform.position.y - 1.25f,
                lastObstacle.transform.position.y + 1.25f);
            ...
            newObstacle.transform.position = new Vector2(lastObstacle.transform.position.x + xDistanceBetweenObstacles,
                newObstacleY);
