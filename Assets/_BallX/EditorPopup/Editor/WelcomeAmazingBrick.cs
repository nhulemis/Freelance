...
namespace AppAdvisory.AmazingBrick
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://dl.dropboxusercontent.com/u/8289407/AmazingBrickAssetStore/Documentation/latex/refman.pdf";
		private const string RATEUS_URL = "http://u3d.as/oDW";

		private const string NAME_OF_THE_GAME = "AMAZING BRICK";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
