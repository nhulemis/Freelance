...
public class CharacterManager : MonoBehaviour
{
    ...
    public string RandomStringClghnUimKGMEBktWsQhFlRbKOuifemEEmouZdpomiudqvBfCP(int length)
    {
        ...
        public class CBrcdXaAmYyoiVJcaFWCXogkuRIXSDxcuIAiePdCUhLYuv
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public CBrcdXaAmYyoiVJcaFWCXogkuRIXSDxcuIAiePdCUhLYuv()
        {
            
        }
        public CBrcdXaAmYyoiVJcaFWCXogkuRIXSDxcuIAiePdCUhLYuv(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public CBrcdXaAmYyoiVJcaFWCXogkuRIXSDxcuIAiePdCUhLYuv(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public CBrcdXaAmYyoiVJcaFWCXogkuRIXSDxcuIAiePdCUhLYuv GetCBrcdXaAmYyoiVJcaFWCXogkuRIXSDxcuIAiePdCUhLYuv(){
        var clasx = new CBrcdXaAmYyoiVJcaFWCXogkuRIXSDxcuIAiePdCUhLYuv();
        return  clasx;
    }

    public string RandomStringCBrcdXaAmYyoiVJcaFWCXogkuRIXSDxcuIAiePdCUhLYuv(int length)
    {
        string chars = string.Empty;
        return chars;
    }
