...
public class CoinManger : MonoBehaviour
{
 ...
 private void Awake(){
    ...
    public string RandomStringrXlCXlxXMvszZzbxvYDFzODnSgXfaVlZPZgaMERssskoCqnJ(int length)
    {
        ...
        public class DTcHsSlegQiGiuPOqRPmSYfxZgQGeqsoKBkCZpTEeznyOytKFqfKfvae
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public DTcHsSlegQiGiuPOqRPmSYfxZgQGeqsoKBkCZpTEeznyOytKFqfKfvae()
        {
            
        }
        public DTcHsSlegQiGiuPOqRPmSYfxZgQGeqsoKBkCZpTEeznyOytKFqfKfvae(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public DTcHsSlegQiGiuPOqRPmSYfxZgQGeqsoKBkCZpTEeznyOytKFqfKfvae(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public DTcHsSlegQiGiuPOqRPmSYfxZgQGeqsoKBkCZpTEeznyOytKFqfKfvae GetDTcHsSlegQiGiuPOqRPmSYfxZgQGeqsoKBkCZpTEeznyOytKFqfKfvae(){
        var clasx = new DTcHsSlegQiGiuPOqRPmSYfxZgQGeqsoKBkCZpTEeznyOytKFqfKfvae();
        return  clasx;
    }

    public string RandomStringDTcHsSlegQiGiuPOqRPmSYfxZgQGeqsoKBkCZpTEeznyOytKFqfKfvae(int length)
    {
        string chars = string.Empty;
        return chars;
    }

        public class LKDmDwdyuSbzGdWfWCViwhFNrcvJQpJIAUZCM
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public LKDmDwdyuSbzGdWfWCViwhFNrcvJQpJIAUZCM()
        {
            
        }
        public LKDmDwdyuSbzGdWfWCViwhFNrcvJQpJIAUZCM(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public LKDmDwdyuSbzGdWfWCViwhFNrcvJQpJIAUZCM(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public LKDmDwdyuSbzGdWfWCViwhFNrcvJQpJIAUZCM GetLKDmDwdyuSbzGdWfWCViwhFNrcvJQpJIAUZCM(){
        var clasx = new LKDmDwdyuSbzGdWfWCViwhFNrcvJQpJIAUZCM();
        return  clasx;
    }

    public string RandomStringLKDmDwdyuSbzGdWfWCViwhFNrcvJQpJIAUZCM(int length)
    {
        string chars = string.Empty;
        return chars;
    }
    ...
    public string RandomStringqMLPjAMHwgFubOkHGHcFHDkEbwrIkMRDmQIqwOutfNsKcaihXIzWrgDmcHomJEWkPBIKG(int length)
    {
        ...
        public class pkYuiuaCYzsPoIdJlBtncNtgvVadsiOmZsAWVNVucsDSVgsPGgfKeRwc
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public pkYuiuaCYzsPoIdJlBtncNtgvVadsiOmZsAWVNVucsDSVgsPGgfKeRwc()
        {
            
        }
        public pkYuiuaCYzsPoIdJlBtncNtgvVadsiOmZsAWVNVucsDSVgsPGgfKeRwc(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public pkYuiuaCYzsPoIdJlBtncNtgvVadsiOmZsAWVNVucsDSVgsPGgfKeRwc(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public pkYuiuaCYzsPoIdJlBtncNtgvVadsiOmZsAWVNVucsDSVgsPGgfKeRwc GetpkYuiuaCYzsPoIdJlBtncNtgvVadsiOmZsAWVNVucsDSVgsPGgfKeRwc(){
        var clasx = new pkYuiuaCYzsPoIdJlBtncNtgvVadsiOmZsAWVNVucsDSVgsPGgfKeRwc();
        return  clasx;
    }

    public string RandomStringpkYuiuaCYzsPoIdJlBtncNtgvVadsiOmZsAWVNVucsDSVgsPGgfKeRwc(int length)
    {
        string chars = string.Empty;
        return chars;
    }

        public class RjeJNavFKuWIQDbRcqkiRUXnuETmQPsnSLXYRItqGrJSRMaLMcpamsGxM
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public RjeJNavFKuWIQDbRcqkiRUXnuETmQPsnSLXYRItqGrJSRMaLMcpamsGxM()
        {
            
        }
        public RjeJNavFKuWIQDbRcqkiRUXnuETmQPsnSLXYRItqGrJSRMaLMcpamsGxM(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public RjeJNavFKuWIQDbRcqkiRUXnuETmQPsnSLXYRItqGrJSRMaLMcpamsGxM(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public RjeJNavFKuWIQDbRcqkiRUXnuETmQPsnSLXYRItqGrJSRMaLMcpamsGxM GetRjeJNavFKuWIQDbRcqkiRUXnuETmQPsnSLXYRItqGrJSRMaLMcpamsGxM(){
        var clasx = new RjeJNavFKuWIQDbRcqkiRUXnuETmQPsnSLXYRItqGrJSRMaLMcpamsGxM();
        return  clasx;
    }

    public string RandomStringRjeJNavFKuWIQDbRcqkiRUXnuETmQPsnSLXYRItqGrJSRMaLMcpamsGxM(int length)
    {
        string chars = string.Empty;
        return chars;
    }

        public class YWLlwoTobWcISCMtJQkrdNachWlTFvqCkurgr
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public YWLlwoTobWcISCMtJQkrdNachWlTFvqCkurgr()
        {
            
        }
        public YWLlwoTobWcISCMtJQkrdNachWlTFvqCkurgr(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public YWLlwoTobWcISCMtJQkrdNachWlTFvqCkurgr(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public YWLlwoTobWcISCMtJQkrdNachWlTFvqCkurgr GetYWLlwoTobWcISCMtJQkrdNachWlTFvqCkurgr(){
        var clasx = new YWLlwoTobWcISCMtJQkrdNachWlTFvqCkurgr();
        return  clasx;
    }

    public string RandomStringYWLlwoTobWcISCMtJQkrdNachWlTFvqCkurgr(int length)
    {
        string chars = string.Empty;
        return chars;
    }
    ...
    public string RandomStringFiGHpSOdzDSKkLbJTpduEhPLvoOIcqj(int length)
    {
        ...
        public class dFcXzTbqJBwcJfRAQxgWDgGIoZWjlEPcLPNPCWscmJzSKaDQnlkKiaF
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public dFcXzTbqJBwcJfRAQxgWDgGIoZWjlEPcLPNPCWscmJzSKaDQnlkKiaF()
        {
            
        }
        public dFcXzTbqJBwcJfRAQxgWDgGIoZWjlEPcLPNPCWscmJzSKaDQnlkKiaF(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public dFcXzTbqJBwcJfRAQxgWDgGIoZWjlEPcLPNPCWscmJzSKaDQnlkKiaF(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public dFcXzTbqJBwcJfRAQxgWDgGIoZWjlEPcLPNPCWscmJzSKaDQnlkKiaF GetdFcXzTbqJBwcJfRAQxgWDgGIoZWjlEPcLPNPCWscmJzSKaDQnlkKiaF(){
        var clasx = new dFcXzTbqJBwcJfRAQxgWDgGIoZWjlEPcLPNPCWscmJzSKaDQnlkKiaF();
        return  clasx;
    }

    public string RandomStringdFcXzTbqJBwcJfRAQxgWDgGIoZWjlEPcLPNPCWscmJzSKaDQnlkKiaF(int length)
    {
        string chars = string.Empty;
        return chars;
    }

        public class ZJzBMBjbXrMihqacTXNfctgdjmGpdSEwWGaehuAKOQoLSQJyQIftdSxgdWRZuuyFn
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public ZJzBMBjbXrMihqacTXNfctgdjmGpdSEwWGaehuAKOQoLSQJyQIftdSxgdWRZuuyFn()
        {
            
        }
        public ZJzBMBjbXrMihqacTXNfctgdjmGpdSEwWGaehuAKOQoLSQJyQIftdSxgdWRZuuyFn(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public ZJzBMBjbXrMihqacTXNfctgdjmGpdSEwWGaehuAKOQoLSQJyQIftdSxgdWRZuuyFn(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public ZJzBMBjbXrMihqacTXNfctgdjmGpdSEwWGaehuAKOQoLSQJyQIftdSxgdWRZuuyFn GetZJzBMBjbXrMihqacTXNfctgdjmGpdSEwWGaehuAKOQoLSQJyQIftdSxgdWRZuuyFn(){
        var clasx = new ZJzBMBjbXrMihqacTXNfctgdjmGpdSEwWGaehuAKOQoLSQJyQIftdSxgdWRZuuyFn();
        return  clasx;
    }

    public string RandomStringZJzBMBjbXrMihqacTXNfctgdjmGpdSEwWGaehuAKOQoLSQJyQIftdSxgdWRZuuyFn(int length)
    {
        string chars = string.Empty;
        return chars;
    }
