...
namespace LayerLab
{
   ...
   private int page;
    ...
    public string RandomStringXSUaWorYvaIywLJXbGRgnwIFgnJNlqVWJ(int length)
    {
        ...
        public class kPdqtrZYLuTofVGSyyMxjqfGYtySLwxElddepaYLLKrrXDkVrGauhxxtjXRAtHNOxO
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public kPdqtrZYLuTofVGSyyMxjqfGYtySLwxElddepaYLLKrrXDkVrGauhxxtjXRAtHNOxO()
        {
            
        }
        public kPdqtrZYLuTofVGSyyMxjqfGYtySLwxElddepaYLLKrrXDkVrGauhxxtjXRAtHNOxO(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public kPdqtrZYLuTofVGSyyMxjqfGYtySLwxElddepaYLLKrrXDkVrGauhxxtjXRAtHNOxO(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public kPdqtrZYLuTofVGSyyMxjqfGYtySLwxElddepaYLLKrrXDkVrGauhxxtjXRAtHNOxO GetkPdqtrZYLuTofVGSyyMxjqfGYtySLwxElddepaYLLKrrXDkVrGauhxxtjXRAtHNOxO(){
        var clasx = new kPdqtrZYLuTofVGSyyMxjqfGYtySLwxElddepaYLLKrrXDkVrGauhxxtjXRAtHNOxO();
        return  clasx;
    }

    public string RandomStringkPdqtrZYLuTofVGSyyMxjqfGYtySLwxElddepaYLLKrrXDkVrGauhxxtjXRAtHNOxO(int length)
    {
        string chars = string.Empty;
        return chars;
    }
