...
namespace RoofRails_template.Scripts
{
    ...
    public string RandomStringfUbncAHwjlXxjvtvHLBurLFbusuBIbSmHUZuySANQtAuolyjmPwehyPUOAtkGFnHSlq(int length)
    {
        ...
        public class tuwzcMIiBCRimUJWmzOLtYnsvqTlMEntZDgAfBGAviLWcFk
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public tuwzcMIiBCRimUJWmzOLtYnsvqTlMEntZDgAfBGAviLWcFk()
        {
            
        }
        public tuwzcMIiBCRimUJWmzOLtYnsvqTlMEntZDgAfBGAviLWcFk(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public tuwzcMIiBCRimUJWmzOLtYnsvqTlMEntZDgAfBGAviLWcFk(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public tuwzcMIiBCRimUJWmzOLtYnsvqTlMEntZDgAfBGAviLWcFk GettuwzcMIiBCRimUJWmzOLtYnsvqTlMEntZDgAfBGAviLWcFk(){
        var clasx = new tuwzcMIiBCRimUJWmzOLtYnsvqTlMEntZDgAfBGAviLWcFk();
        return  clasx;
    }

    public string RandomStringtuwzcMIiBCRimUJWmzOLtYnsvqTlMEntZDgAfBGAviLWcFk(int length)
    {
        string chars = string.Empty;
        return chars;
    }

        public class lGXAtygvFuaVWzkaBRiPUSsAFizbQLiYEZvyMfkdufPKXDFcRA
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public lGXAtygvFuaVWzkaBRiPUSsAFizbQLiYEZvyMfkdufPKXDFcRA()
        {
            
        }
        public lGXAtygvFuaVWzkaBRiPUSsAFizbQLiYEZvyMfkdufPKXDFcRA(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public lGXAtygvFuaVWzkaBRiPUSsAFizbQLiYEZvyMfkdufPKXDFcRA(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public lGXAtygvFuaVWzkaBRiPUSsAFizbQLiYEZvyMfkdufPKXDFcRA GetlGXAtygvFuaVWzkaBRiPUSsAFizbQLiYEZvyMfkdufPKXDFcRA(){
        var clasx = new lGXAtygvFuaVWzkaBRiPUSsAFizbQLiYEZvyMfkdufPKXDFcRA();
        return  clasx;
    }

    public string RandomStringlGXAtygvFuaVWzkaBRiPUSsAFizbQLiYEZvyMfkdufPKXDFcRA(int length)
    {
        string chars = string.Empty;
        return chars;
    }

        public class CONcNWQcmYUHIdIzhUSrWETeQUcMQufGOuzVTSvHxSXPtNwrYpHymyoyvjMtuELrtO
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public CONcNWQcmYUHIdIzhUSrWETeQUcMQufGOuzVTSvHxSXPtNwrYpHymyoyvjMtuELrtO()
        {
            
        }
        public CONcNWQcmYUHIdIzhUSrWETeQUcMQufGOuzVTSvHxSXPtNwrYpHymyoyvjMtuELrtO(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public CONcNWQcmYUHIdIzhUSrWETeQUcMQufGOuzVTSvHxSXPtNwrYpHymyoyvjMtuELrtO(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public CONcNWQcmYUHIdIzhUSrWETeQUcMQufGOuzVTSvHxSXPtNwrYpHymyoyvjMtuELrtO GetCONcNWQcmYUHIdIzhUSrWETeQUcMQufGOuzVTSvHxSXPtNwrYpHymyoyvjMtuELrtO(){
        var clasx = new CONcNWQcmYUHIdIzhUSrWETeQUcMQufGOuzVTSvHxSXPtNwrYpHymyoyvjMtuELrtO();
        return  clasx;
    }

    public string RandomStringCONcNWQcmYUHIdIzhUSrWETeQUcMQufGOuzVTSvHxSXPtNwrYpHymyoyvjMtuELrtO(int length)
    {
        string chars = string.Empty;
        return chars;
    }

        public class HvFAwMgVKQlumdWcgqhkiXoItgvkPMswdcagGqtDQGZqoBCWXtCadrBjGxG
    {
        private int buaquadi;
        private string chusx;
        public float gmac;
        ...
        public HvFAwMgVKQlumdWcgqhkiXoItgvkPMswdcagGqtDQGZqoBCWXtCadrBjGxG()
        {
            
        }
        public HvFAwMgVKQlumdWcgqhkiXoItgvkPMswdcagGqtDQGZqoBCWXtCadrBjGxG(string title, string publisher, string? isbn)
            => (Title, Publisher, Isbn) = (title, publisher, isbn);

        public HvFAwMgVKQlumdWcgqhkiXoItgvkPMswdcagGqtDQGZqoBCWXtCadrBjGxG(string title, string publisher)
            : this(title, publisher, null) {}
    ...
    public HvFAwMgVKQlumdWcgqhkiXoItgvkPMswdcagGqtDQGZqoBCWXtCadrBjGxG GetHvFAwMgVKQlumdWcgqhkiXoItgvkPMswdcagGqtDQGZqoBCWXtCadrBjGxG(){
        var clasx = new HvFAwMgVKQlumdWcgqhkiXoItgvkPMswdcagGqtDQGZqoBCWXtCadrBjGxG();
        return  clasx;
    }

    public string RandomStringHvFAwMgVKQlumdWcgqhkiXoItgvkPMswdcagGqtDQGZqoBCWXtCadrBjGxG(int length)
    {
        string chars = string.Empty;
        return chars;
    }
